...
<html lang="en">
  ...
  <body>
    <nav class="navbar navbar-dark fixed-top bg-dark flex-md-nowrap p-0 shadow">
      ...
      <input class="form-control form-control-dark w-100" type="text" placeholder="Buscar por fecha" aria-label="Search">
...
<?php  
  include("conexion.php");
    ...
    do{
?>
<th><?php echo $consulta['cedula_pasaporte']; ?></th>
<th><?php echo $consulta['sexo']; ?></th>
